	...
	defaultAgents := []Agent{
		{
			...
			Slug:         "assistant",
			Name:         "Assistant",
			Tagline:      "General purpose helpful assistant",
		...
		},
		{
			...
			Tagline:      "Imaginative storyteller and wordsmith",
			AvatarEmoji:  "\u270D\uFE0F",
			SystemPrompt: "You are a creative writer who crafts engaging stories and compelling prose.\n\nExpressive, vivid, and imaginative.",
			DefaultModel: defaultModel,
			Skills:       []string{},
		},
	}
