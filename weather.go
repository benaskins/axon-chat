...
func (c *OpenMeteoClient) GetWeather(ctx context.Context, location string) (*WeatherResult, error) {
	...
	geoURL, err := url.Parse("https://geocoding-api.open-meteo.com/v1/search")
	if err != nil {
	...
	wxURL, err := url.Parse("https://api.open-meteo.com/v1/forecast")
	if err != nil {
	...
	return &WeatherResult{
		...
		WindDir:     wx.CurrentWeather.WindDirection,
